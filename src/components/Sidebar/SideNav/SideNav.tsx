...
import products from "../../../img/light_theme/products.svg"
    ...
    return (
        <div>
            <nav className="sidebar__nav sidebar-nav">
                ...
                <NavLink to={"products"} className={({isActive}) => isActive ? 'sidebar-nav__active-link sidebar-nav__link' : 'sidebar-nav__link'}><img src={products}
                                                                                                                                                    alt={"list"} className={"sidebar-nav__img"}/></NavLink>
